...
import { CounterCreatedProductEventPublisherBase } from 'src/subdomains/store/contexts'
import { ProductEntity } from '../../../persistence/entities'

@Injectable()
export class CreatedProductPublisher extends CounterCreatedProductEventPublisherBase {
    /**
     ...
     * 
     * Creates an instance of CreatedProductPublisher.
