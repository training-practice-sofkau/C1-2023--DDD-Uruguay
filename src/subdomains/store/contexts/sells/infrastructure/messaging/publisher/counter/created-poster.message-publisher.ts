...
import { CounterCreatedPosterEventPublisherBase } from 'src/subdomains/store/contexts'
import { PosterEntity } from '../../../persistence/entities'

@Injectable()
export class CreatedPosterPublisher extends CounterCreatedPosterEventPublisherBase {
    /**
     ...
     * 
     * Creates an instance of CreatedPosterPublisher.
     * @param {ClientProxy} proxy
     * @memberof CreatedPosterPublisher
     */
    constructor(
    ...
    /**
     * El método emit en CreatedPosterPublisher utiliza lastValueFrom de rxjs
