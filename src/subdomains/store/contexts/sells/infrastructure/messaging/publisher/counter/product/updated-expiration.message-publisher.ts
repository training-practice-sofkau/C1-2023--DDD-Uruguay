...
import { ProductUpdatedExpirationEventPublisherBase } from 'src/subdomains/store/contexts/sells/domain';
import { ProductEntity } from '../../../../persistence/entities';

@Injectable()
export class UpdatedExpirationPublisher extends ProductUpdatedExpirationEventPublisherBase {
    /**
     ...
     * 
     * Creates an instance of UpdatedExpirationPublisher.
     * @param {ClientProxy} proxy
     * @memberof UpdatedExpirationPublisher
     */
    constructor(
    ...
    /**
     * El método emit en UpdatedExpirationPublisher utiliza lastValueFrom de rxjs
