...
import { PosterUpdatedPriceEventPublisherBase } from 'src/subdomains/store/contexts/sells/domain';
import { PosterEntity } from '../../../../persistence/entities';

@Injectable()
export class UpdatedPricePublisher extends PosterUpdatedPriceEventPublisherBase {
    /**
