...
import { IClientAddEventPublisher, IClientModifiedEventPublisher, IClientObtainedEventPublisher, IMangaModifiedEventPublisher, IMangaObtainedEventPublisher, INameModifiedEventPublisher, IOrderAddEventPublisher, IOrderModifiedEventPublisher, IPhoneModifiedEventPublisher } from './publisher/order';
...
import { ISalesObtainedEventPublisher, ISellerModifiedEventPublisher, IAddedSellerEventPublisher, IBillModifiedEventPublisher, IPaymentMethodEventPublisher } from "./publisher/Sale";
...
@Module({
    ...
    providers: [IOrderAddEventPublisher, IClientAddEventPublisher, IBillObtainedEventPublisher,
         IAddedSaleEventPublisher,INameMangaModifiedEventPublisher,
    ...
    exports: [IOrderAddEventPublisher, IClientAddEventPublisher,IBillObtainedEventPublisher,
        IAddedSaleEventPublisher,INameMangaModifiedEventPublisher,IUpdateNameSellerName,
