    ...
    implements IUseCase<Command, Response>
{
    ...
    private async executeCommand(
        ...
        } else throw new AggregateUpdateException('Hay algunos errores en el comando ejecutado por UpdateEmployedNameUserCase');
    }

    private validateObjectValue(valueObject: EmployedNameValueObject): void {

        if (valueObject instanceof EmployedNameValueObject && valueObject.hasErrors())
