    ...
    implements IUseCase<Command, Response>
{
    ...
    private async executeCommand(
        ...
        } else throw new AggregateUpdateException('Hay algunos errores en el comando ejecutado por UpdateBenefitedNameUserCase');
    }

    private validateObjectValue(valueObject: BenefitedNameValueObject): void {

        if (valueObject instanceof BenefitedNameValueObject && valueObject.hasErrors())
