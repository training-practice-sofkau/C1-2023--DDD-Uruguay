    ...
    implements IUseCase<Command, Response>
{
    ...
    private async executeCommand(
        ...
        } else throw new AggregateUpdateException('Hay algunos errores en el comando ejecutado por UpdateBenefitedPhoneUserCase');
    }

    private validateObjectValue(valueObject: BenefitedPhoneValueObject): void {

        if (valueObject instanceof BenefitedPhoneValueObject && valueObject.hasErrors())
