    ...
    implements IUseCase<Command, Response>
{
    ...
    private async executeCommand(
        ...
        } else throw new AggregateUpdateException('Hay algunos errores en el comando ejecutado por UpdateEmployedPhoneUserCase');
    }

    private validateObjectValue(valueObject: EmployedPhoneValueObject): void {

        if (valueObject instanceof EmployedPhoneValueObject && valueObject.hasErrors())
